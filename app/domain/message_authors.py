"""Domain value objects used by message persistence and application services."""
...
def validate_message_author_storage(author_type: str, author_user_id: UUID | None, metadata: dict[str, Any]) -> None:
