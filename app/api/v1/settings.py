...
def _response(tenant: Tenant, settings: TenantSettings) -> TenantSettingsPayload:
    return TenantSettingsPayload(
        ...
        business_hours=BusinessHours.model_validate(settings.business_hours or {}),
        off_hours_policy=OffHoursPolicy.model_validate(settings.off_hours_policy or {}),
        contact_info=ContactInfo.model_validate(settings.contact_info or {}),
